...
const TrackInfoChart_1 = __importDefault(require("./TrackInfoChart"));
const AddedTracksTable_1 = __importDefault(require("./AddedTracksTable"));
const App = () => {
    const { selectedOption, setSelectedOption, playlists, setPlaylists, selectedPlaylist, setSelectedPlaylist, visitedPlaylists, setVisitedPlaylists, isLoading, setIsLoading, showPlaylists, setShowPlaylists, showTracks, setShowTracks, showVisitedPlaylists, setShowVisitedPlaylists, showRecommendations, setShowRecommendations, playlistId, setPlaylistId, message, setMessage, messageType, setMessageType, addedTracks, setAddedTracks, } = (0, useApp_1.useApp)();
    const [selectedTrack, setSelectedTrack] = react_1.default.useState(null);
    ...
    return (react_1.default.createElement(CombinedContext_1.default.Provider, { value: {
        ...
        react_1.default.createElement(PlaylistIdContext_1.default.Provider, { value: { playlistId, setPlaylistId } },
            react_1.default.createElement("div", { className: "App pt-16" },
                ...
                react_1.default.createElement("div", { className: "my-4" }, showRecommendations &&
                    react_1.default.createElement(AddedTracksTable_1.default, null)),
