...
const RadioButton = () => {
    const { selectedOption, setSelectedOption } = (0, react_1.useContext)(CombinedContext_1.default);
    ...
    return (react_1.default.createElement("div", { className: "radio-group flex justify-center my-5" }, options.map((option) => (react_1.default.createElement("div", { className: "mx-2", key: option.id },
